...
streak_finder_min_pixels = 10
streak_finder_max_area = 2000
streak_finder_num_streaks_threshold = 10
...
mask_file = f"{prop_dir}/usr/Shared/hummingbird/mask_for_hummingbird.h5"
with h5py.File(mask_file, "r") as maskh5:
    mask_h5 = np.array(maskh5["entry_1/goodpixels"])

# background whitefield file (dividing) ------------------------------------------

whitefield_file = f"{prop_dir}/usr/Shared/hummingbird/white_field_for_hummingbird.h5"
...
apply_background_division = True
apply_background_subtraction = not apply_background_division
